...
namespace SpacetimeDB.Types
{
    ...
    public sealed class QueryBuilder
    {
        ...
        internal static string[] AllTablesSqlQueries() => new string[]
        {
            ...
            new QueryBuilder().From.Winstreak().ToSql(),
        }
        ;
    }
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<WinStreak, WinstreakCols, WinstreakIxCols> Winstreak() => new("winstreak", new WinstreakCols("winstreak"), new WinstreakIxCols("winstreak"));
    }
